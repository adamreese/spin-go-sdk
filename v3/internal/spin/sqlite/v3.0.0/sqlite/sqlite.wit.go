...
// Package sqlite represents the imported interface "spin:sqlite/sqlite@3.0.0".
package sqlite
...
// Connection represents the imported resource "spin:sqlite/sqlite@3.0.0#connection".
//
...
// Changes represents the imported method "changes".
//
...
//
//go:nosplit
func (self Connection) Changes() (result uint64) {
	self0 := cm.Reinterpret[uint32](self)
	result0 := wasmimport_ConnectionChanges((uint32)(self0))
...
// LastInsertRowid represents the imported method "last-insert-rowid".
//
...
//
//go:nosplit
func (self Connection) LastInsertRowid() (result int64) {
	self0 := cm.Reinterpret[uint32](self)
	result0 := wasmimport_ConnectionLastInsertRowid((uint32)(self0))
	result = (int64)((uint64)(result0))
	return
}

// Error represents the variant "spin:sqlite/sqlite@3.0.0#error".
//
...
// Value represents the variant "spin:sqlite/sqlite@3.0.0#value".
//
...
// RowResult represents the record "spin:sqlite/sqlite@3.0.0#row-result".
//
...
// QueryResult represents the record "spin:sqlite/sqlite@3.0.0#query-result".
//
// A result of a query
//
//	record query-result {
