...
// Package store represents the imported interface "wasi:config/store@0.2.0-draft-x2024-x09-x27".
package store
...
// Error represents the variant "wasi:config/store@0.2.0-draft-x2024-x09-x27#error".
//
